        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form role="form" method="post" action="/hyxinfo/people/saveList">
                        <input type="text" style="display:none;" name="billId" value="${(empData.billId)!''}">
                        <div class="form-group">
                            <label>载重(吨)</label>
                            <input type="number" step="0.01" class="form-control" name="weights"
                                   value="${(empData.weights)!''}"/>
                        </div>
                        <div class="form-group">
                            <label>货运地址</label>
                        ...
                        <div class="col-sm-2 col-lg-offset-1">
                            ...
                            <input type="text" class="form-control" name="createTime"
                                   value="${(empData.createTime?string("yyyy-MM-dd HH:mm:ss"))!''}"/>
                        </div>
                        <div class="col-md-12 ">
